...
<api>POST https://{handle}.blutui.com/admin/api/blogs</api>
...
<api>GET https://{handle}.blutui.com/admin/api/blogs/{id}</api>
...
<api>PATCH https://{handle}.blutui.com/admin/api/blogs/{id}</api>
...
<api>DELETE https://{handle}.blutui.com/admin/api/blogs/{id}</api>

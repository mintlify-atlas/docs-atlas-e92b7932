...
<api>POST https://{handle}.blutui.com/admin/api/posts</api>
...
<api>GET https://{handle}.blutui.com/admin/api/posts/{id}</api>
...
<api>PATCH https://{handle}.blutui.com/admin/api/posts/{id}</api>
...
<api>DELETE https://{handle}.blutui.com/admin/api/posts/{id}</api>

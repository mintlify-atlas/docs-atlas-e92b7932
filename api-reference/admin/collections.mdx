...
<api>POST https://{handle}.blutui.com/admin/api/collections</api>
...
<api>GET https://{handle}.blutui.com/admin/api/collections/{id}</api>
...
<api>PATCH https://{handle}.blutui.com/admin/api/collections/{id}</api>
...
<api>DELETE https://{handle}.blutui.com/admin/api/collections/{id}</api>

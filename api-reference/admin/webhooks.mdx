...
<api>POST https://{handle}.blutui.com/admin/api/webhooks</api>
...
<api>GET https://{handle}.blutui.com/admin/api/webhooks/{id}</api>
...
<api>PATCH https://{handle}.blutui.com/admin/api/webhooks/{id}</api>
...
<api>DELETE https://{handle}.blutui.com/admin/api/webhooks/{id}</api>

...
**`POST https://{handle}.blutui.com/admin/api/forms`**
...
**`GET https://{handle}.blutui.com/admin/api/forms/{id}`**
...
**`PATCH https://{handle}.blutui.com/admin/api/forms/{id}`**
...
**`DELETE https://{handle}.blutui.com/admin/api/forms/{id}`**

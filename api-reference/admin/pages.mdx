...
**`POST https://{handle}.blutui.com/admin/api/pages`**
...
**`GET https://{handle}.blutui.com/admin/api/pages/{id}`**
...
**`PATCH https://{handle}.blutui.com/admin/api/pages/{id}`**
...
**`DELETE https://{handle}.blutui.com/admin/api/pages/{id}`**

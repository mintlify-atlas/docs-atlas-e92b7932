...
**`POST https://api.blutui.com/v1/agencies/{username}/brand`**
...
**`PATCH https://api.blutui.com/v1/agencies/{username}/brand`**
...
**`DELETE https://api.blutui.com/v1/agencies/{username}/brand`**

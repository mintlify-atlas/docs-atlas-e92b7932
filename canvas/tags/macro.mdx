---
title: macro
description: Create reusable template fragments similar to functions.
---
...
## Using macros in the same template
...
Canvas allows you to put the name of the macro after the end tag for better readability:

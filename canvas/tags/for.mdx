---
title: for
description: Loop over sequences and collections.
---
...
You might want to iterate over a subset of values. This can be achieved using the [slice](/canvas/filters/overview#slice) filter:

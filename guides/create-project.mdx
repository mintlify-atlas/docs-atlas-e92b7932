...
Get a visual feel of your project by clicking on the **Preview** button located at the bottom left of the sidebar. You'll be shown a basic project template, inclusive of [Courier](/courier/getting-started) instructions similar to what you encountered in the earlier steps.
</Step>
